...
//export function contains.not (attr, query) {
//  return function (item) {
...
var RSM_ATTRIBUTS = ['with', 'start', 'end'];
...
export function wrappedChatBox(chatbox) {
  if (!chatbox) { return; }
...
var API = {
  ...
  'chats': {
    ...
    'get': function (jids) {
      if (typeof jids === "undefined") {
        console.log("chats.get: You need to provide at least one JID", "error");
        return null;
      } else if (typeof jids === "string") {
...
export var converse;
export var RSM_ATTRIBUTES;
export var MAM_ATTRIBUTES;
export var STATUS_WEIGHTS;
export var API;

//export function contains;
//export function wrappedChatBox;
